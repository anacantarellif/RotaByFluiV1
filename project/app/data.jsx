// data.jsx — São Paulo mock dataset for Rota by Flui. Exports: DATA
const DATA = {
  user: {
  ...
  // map space ≈ 1000 × 1500; user near 500,770
  user_xy: { x: 500, y: 772 },
  ...
  reports: [
    { id: 'r1', x: 520, y: 760, lat: -23.5735, lng: -46.6975, type: 'fila', icon: 'users', color: 'var(--busy)', kind: 'Fila / lotado', label: 'Fila moderada agora', who: 'Pedro', when: '8 min', station: 'Shopping Eldorado', confirms: 6,
      desc: 'Dois carros esperando vaga. A rotatividade está boa — a espera média é de 15 a 20 minutos.' },
    { id: 'r2', x: 600, y: 1010, lat: -23.6100, lng: -46.6945, type: 'quebrado', icon: 'alert', color: 'var(--off)', kind: 'Fora do ar', label: 'Carregador fora do ar', who: 'Lucas', when: '22 min', station: 'Posto Ipiranga · Faria Lima', confirms: 11,
      desc: 'O conector CCS2 não inicia a sessão. O da esquerda (Type 2) segue funcionando normalmente.' },
    { id: 'r3', x: 430, y: 880, lat: -23.5450, lng: -46.6585, type: 'preco', icon: 'dollar', color: 'var(--primary)', kind: 'Preço mudou', label: 'Preço atualizado: R$ 1,79', who: 'Sofia', when: '1 h', station: 'Pátio Higienópolis', confirms: 4,
      desc: 'Subiu de R$ 1,65 para R$ 1,79 por kWh. Ainda é um dos melhores preços da Zona Oeste.' },
    { id: 'r4', x: 470, y: 660, lat: -23.5885, lng: -46.6560, type: 'livre', icon: 'check', color: 'var(--ok)', kind: 'Pontos livres', label: '2 pontos livres agora', who: 'Marina', when: '3 min', station: 'Parque Ibirapuera', confirms: 9,
  ...
  guides: [
    {
      ...
      stops: [
        { kind: 'start', name: 'São Paulo', sub: 'Saída pela Rod. Ayrton Senna', time: '08:00' },
    ...
    },
    {
      ...
      stops: [
        { kind: 'start', name: 'São Paulo', sub: 'Saída pela Carvalho Pinto', time: '07:30' },
    ...
    },
    {
      ...
      stops: [
        { kind: 'start', name: 'São Paulo', sub: 'Saída pela Castello Branco', time: '10:00' },
    ...
    },
    {
      ...
      stops: [
        { kind: 'start', name: 'São Paulo', sub: 'Saída pela Av. dos Estados', time: '09:00' },
