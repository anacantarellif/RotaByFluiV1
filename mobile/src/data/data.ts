...
export const DATA: RotaData = {
  ...
  route: {
    ...
    stops: [
      { kind: 'start', name: 'Pinheiros', sub: 'Saída · bateria 62%', battery: 62, lat: -23.5613, lng: -46.6825 },
      { kind: 'charge', name: 'Eletroposto Bandeirantes', sub: 'Recarga 18 min · 50→80% · km 32', power: 150, time: 18, battery: 80, selo: 2, lat: -23.3550, lng: -46.7550 },
      { kind: 'end', name: 'Campinas', sub: 'Chegada · bateria 54%', battery: 54, lat: -22.9099, lng: -47.0626 },
    ],
  },
  ...
  guides: [
    {
      ...
      stops: [
        { kind: 'start', name: 'São Paulo', sub: 'Saída pela Rod. Ayrton Senna', time: '08:00', todo: '', lat: -23.5505, lng: -46.6333 },
        { kind: 'stop', name: 'Tremembé', sub: 'Café colonial da serra', time: '09:30', dur: '45 min', icon: 'coffee', todo: 'Pães de queijo, bolos e o famoso café colonial antes de pegar altitude.', lat: -22.9583, lng: -45.5497 },
        { kind: 'charge', name: 'Taubaté · Via Vale', sub: 'Recarga · 45 → 85%', time: '10:40', dur: '35 min', power: 150, selo: 2, todo: 'Almoço no shopping enquanto o carro recupera o fôlego para a subida.', lat: -23.0265, lng: -45.5556 },
        { kind: 'stop', name: 'Campos do Jordão · Capivari', sub: '2 noites', time: '12:30', dur: '2 noites', icon: 'mountain', todo: 'Chocolate quente, cervejarias artesanais e o Horto Florestal logo cedo.', lat: -22.7397, lng: -45.5911 },
        { kind: 'end', name: 'Pico do Itapeva', sub: 'Pôr do sol', time: 'Dia 2 · 17:00', icon: 'sun', todo: 'O mirante mais alto da região. Leve casaco — e a câmera.', lat: -22.7583, lng: -45.5225 },
      ],
    },
    {
      ...
      stops: [
        { kind: 'start', name: 'São Paulo', sub: 'Saída pela Carvalho Pinto', time: '07:30', todo: '', lat: -23.5505, lng: -46.6333 },
        { kind: 'charge', name: 'Caraguatatuba · Serramar', sub: 'Recarga · 30 → 80%', time: '10:00', dur: '40 min', power: 120, selo: 2, todo: 'Pé na areia e um caldo de cana enquanto o carro enche para o fim de semana.', lat: -23.6247, lng: -45.4128 },
        { kind: 'stop', name: 'Praia do Félix', sub: 'Manhã de praia', time: '11:30', dur: '3 h', icon: 'sun', todo: 'Mar calmo numa enseada protegida — a preferida das famílias.', lat: -23.3706, lng: -44.8378 },
        { kind: 'stop', name: 'Itamambuca', sub: 'Surf & mata atlântica', dur: 'tarde', icon: 'leaf', todo: 'Point de surfe com a floresta colada na areia. Fim de tarde perfeito.', lat: -23.3897, lng: -44.9236 },
        { kind: 'end', name: 'Centro & Projeto Tamar', sub: '1 – 2 noites', icon: 'food', todo: 'Tartarugas pela manhã, peixe fresco no porto à noite.', lat: -23.4336, lng: -45.0714 },
      ],
    },
    {
      ...
      stops: [
        { kind: 'start', name: 'São Paulo', sub: 'Saída pela Castello Branco', time: '10:00', todo: '', lat: -23.5505, lng: -46.6333 },
        { kind: 'stop', name: 'Estrada do Vinho · km 4', sub: 'Vinícolas', time: '11:00', dur: '2 h', icon: 'leaf', todo: 'Degustação em três cantinas e a famosa alcachofra da região.', lat: -23.5289, lng: -47.0847 },
        { kind: 'stop', name: 'Almoço · cantina italiana', sub: 'Sem pressa', time: '13:00', dur: '2 h', icon: 'food', todo: 'Massa caseira e vinho da casa com vista para os parreirais.', lat: -23.5361, lng: -47.1069 },
        { kind: 'end', name: 'Retorno a São Paulo', sub: 'Volta com ~35%', time: '16:00', icon: 'car', todo: 'Recarga opcional no shopping ao chegar — o trajeto fecha tranquilo.', lat: -23.5505, lng: -46.6333 },
      ],
    },
    {
      ...
      stops: [
        { kind: 'start', name: 'São Paulo', sub: 'Saída pela Av. dos Estados', time: '09:00', todo: '', lat: -23.5505, lng: -46.6333 },
        { kind: 'stop', name: 'Vila de Paranapiacaba', sub: 'Manhã', time: '10:15', dur: '2 h', icon: 'camera', todo: 'O relógio inglês, o Castelinho e as casas vitorianas de madeira.', lat: -23.7789, lng: -46.3061 },
        { kind: 'stop', name: 'Trilha do Mirante', sub: 'Caminhada curta', dur: '2 h', icon: 'mountain', todo: 'Sobe até o mar de morros — leve agasalho, a neblina é traiçoeira.', lat: -23.7822, lng: -46.3003 },
        { kind: 'end', name: 'Café & volta', sub: 'Tarde', icon: 'coffee', todo: 'Chá da tarde no museu ferroviário antes de descer a serra.', lat: -23.7789, lng: -46.3061 },
      ],
    },
  ],
};
